...
",
  comment = paste0("Integrated Population Model ensemble estimates of grey seal abundance for the Scotian Shelf herd. Points represent posterior medians while lines represent the 95% uncertainty intervals. See Hammill et al. (2023) for details.")
)
