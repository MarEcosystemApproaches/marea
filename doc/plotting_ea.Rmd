...
Since our ea class objectse are consistent in their structure and naming, 
it is easier for you to create your own custom function as well. 

Plotting functions can be a great way to produce publication quality plots with consistnet theme and 
colour elements.
