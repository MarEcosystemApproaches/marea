...
#' @param units A character string for the 'value' column (e.g., "tonnes", "kg/tow", "°C").
...
#' )
#' print(bottom_temp_obj) # Note the 'value' column was renamed from 'avg_temp'
#'
...
# -----------------------------------------------------------------------------
# 3. S3 Methods for the `ea_data` Class
# -----------------------------------------------------------------------------
