...
<img src="man/figures/marea_logo_3.png" align="right" height="138" />
...
1.  **A Single, Simple Data Structure**: All time series data in `marea` are stored in a simple and robust `ea_data` object. This provides a consistent, predictable format, whether you are working with temperature, survey indices, or commercial catch.
...
*Introduction to marea*: A guide to the ea_data class and the package philosophy.
*Working with Environmental Data*: Examples using temperature and oceanographic indices.
